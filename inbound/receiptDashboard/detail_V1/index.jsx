...
export default function ReceiptDashboardNew() {
    const {hasActionAccess} = useAuth();
        const PAGE_KEY = "inbound_receiptsDashboardNew";
    ...
    const loadLazyData = () => {
        ...
        networkTimeout = setTimeout(() => {
            ReceiptsDashboardService.getReceiptDetails(selectedFilter, (lazyState)).then((data) => {
    ...
    const loadLazyData1 = () => {
        ...
        networkTimeout1 = setTimeout(() => {
            ReceiptsDashboardService.getReceiptDetailsLot(selectedFilter, (lazyState1)).then((data) => {
                setLoading1(true)
    ...
    const downloadPDF = async () => {
        try {
            ...
            const { blob, receiptCode } = await ReceiptsDashboardService.getPDF(selectedFilter);
    ...
    const rowClassName = (rowData) => {
        ...
        if (rowData.actualQty === null || rowData.actualQty === 0) {
            return ''; // No class applied if QTY is null or 0
        } else if (rowData.expectedQty !== rowData.actualQty) {
            return 'row-warning';
        }
    };
    const header = (
            ...
            <div className="card">
                ...
                <div className="p-fluid formgrid grid">
                    ...
                    <div className="field col-12 md:col-4">
                        <h5>Receipt Date</h5>
                        <p>
                            {date && date !== "-" ? formatReceiptDate(date) : "-"}
                        </p>
                    </div>
            ...
            <div className="card">
                ...
                <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
                    ...
                    <span className="block mt-2 md:mt-0 p-input-icon-left gap-4">
                        {selectedFilter && hasActionAccess(PAGE_KEY, "download_pdf") &&(
                            <Button label="Download PDF" icon="pi pi-file-pdf" severity="danger" onClick={downloadPDF} />
                        )}
                ...
                <div className="w-full overflow-x-auto">
                    ...
                    >
                        ...
                        <Column field="poref" header="PO" body={(rowData) => rowData.po} />
                        {<Column field="mantis_sku" header="SKU (mantis)" body={(rowData) => rowData.mantis_SKU} />}
                        <Column field="x3_sku" header="Input Sku (X3)" body={(rowData) => rowData.itemCode_X3} />
                        ...
                        <Column field="actualQtyDisplay" header="X3 Entry Qty/UOM" body={(rowData) => rowData.actualQtyDisplay} />
                ...
                <div className="w-full overflow-x-auto">
                    ...
                    >
                        ...
                        <Column field="actualLotNumbers" header="Lot Number" body={(rowData) => rowData.lotNumber} />
                        <Column field="exp_date" header="EXP Date" body={(rowData) => rowData.expirationDate} filterMenuStyle={{ width: '14rem' }} />
                        <Column field="actualQtyDisplay" header="X3 Entry Qty/UOM" body={(rowData) => rowData.quantityDisplay} />
                        <Column field="x3_Qty" header="X3 Qty/UOM" body={(rowData) => rowData.x3_QtyDisplay} />
