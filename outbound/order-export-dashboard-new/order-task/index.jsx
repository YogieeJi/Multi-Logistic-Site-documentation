...
export default function Users() {
    ...
    const PAGE_KEY = "order_Export_details";
  ...
  const customizedContent = (item) => {
    ...
    const actionItems = [
        hasActionAccess(PAGE_KEY,"export_order")&&{
            label: 'Export Order',
            icon: 'pi pi-plus',
            command: () => {
         ...
         hasActionAccess(PAGE_KEY,"rerun_export_order")&&{
                    ...
                    onChange={(e) => {
                        ...
                        if (selected) {
                            ...
                            const formattedDate = ("0" + date.getDate()).slice(-2) + "-" +
                                ...
                                date.getFullYear();
                            navigate(`/outbound/orders-export/${selected.pick_list_id}/${selected.customer_code}/${formattedDate}/${selected.is_exported}/${selected.picklist_id}`);
                        }
        ...
        <>
            ...
            <div className="flex justify-content-between align-items-center mb-3">
                <Button
                    ...
                    onClick={() => navigate("/outbound/orders-export-dashboard-new")}
                    style={{ margin: '10px 0' }}
                />
