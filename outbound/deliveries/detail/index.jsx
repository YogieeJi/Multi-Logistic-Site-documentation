...
export default function DeliveryDetails() {
    ...
    const loadLazyData = () => {
        DeliveryService.getDeliveryDetail(params.id).then((data) => {
        ...
        networkTimeout = setTimeout(() => {
            DeliveryService.getDeliveryLines(params.id, (lazyState)).then((data) => {
    ...
    return (
        <>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <h3>Delivery # {deliveryDetail.delivery_number}</h3>
            ...
            <div className="card">
                ...
                <div className="p-fluid formgrid grid">
                    <div className="field col-12 md:col-4">
                        ...
                        <p htmlFor="created_at">{deliveryDetail.created_at}</p>

                    </div>
                 
                    <div className="field col-12 md:col-4">
                        <h5 id="status">Status</h5>
                        <Tag value={statusValue} severity={getSeverity(deliveryDetail.status)} />
