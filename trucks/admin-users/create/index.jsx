 ...
 const dispatch = useDispatch()
    ...
    const onSubmit = async (data) => {
        ...
        try {
            const payload = {
                ...
                userCategoryIds: data.userCategory,
                employeeGroupIds: data.employee,
    ...
    return (
        <div className="card p-fluid">
            <Toast ref={toast} />
            <h2>{isEditMode ? 'Edit User' : 'Create Admin User'}</h2>
...
/>
                ...
                <Button label="Cancel" onClick={() => navigate("/users/adminusers")} type='button' severity="secondary" className="w-2 p-2 mt-2 mr-2 " outlined ></Button>
